...
exports.deleteBookInstance = exports.updateBookInstance = exports.createBookInstance = exports.bookinstanceValidation = exports.getBookInstanceById = exports.getAllBookInstances = void 0;
const celebrate_1 = require("celebrate");
const bookinstance_models_1 = __importDefault(require("../models/bookinstance.models"));
/**
...
const getBookInstanceById = async (req, res) => {
    try {
        const bookinstance = await bookinstance_models_1.default.findByPk(req.params.bookinstanceId);
        if (!bookinstance) {
