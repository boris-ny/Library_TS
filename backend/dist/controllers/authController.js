...
exports.permissionLevelRequired = exports.validJWTNeeded = exports.login = void 0;
...
const login = async (req, res) => {
    ...
    try {
        ...
        const passwordIsValid = await bcrypt_1.default.compare(req.body.password, user.password);
        if (!passwordIsValid) {
            return res.status(401).json({
                status: 401,
                message: "Invalid email or password",
