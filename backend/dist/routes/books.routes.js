...
router
     ...
     */
    .post(authcontroller.permissionLevelRequired([user_models_1.PermissionLevel.ADMIN, user_models_1.PermissionLevel.USER]), bookcontroller.BookValidation, bookcontroller.postBookCreate);
router
    .route("/:bookId")
    /**
     * Middleware to ensure that a valid JWT is provided.
     ...
     * Middleware to ensure that the user has the required permission level.
     */
    .delete(bookcontroller.BookDelete, authcontroller.permissionLevelRequired([user_models_1.PermissionLevel.ADMIN]));
