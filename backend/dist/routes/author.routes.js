...
router
     ...
     */
    .post(authController.permissionLevelRequired([
    user_models_1.PermissionLevel.ADMIN,
    user_models_1.PermissionLevel.USER,
]), 
/**
 ...
 */
authorController.authorValidation, authorController.createAuthor);
router
    .route("/:authorId")
    /**
     * Middleware for validating JWT and permission level.
 ...
 * Middleware for validating author data.
 */
authorController.authorValidation, authorController.updateAuthor)
    /**
 ...
 */
authController.permissionLevelRequired([user_models_1.PermissionLevel.ADMIN]));
