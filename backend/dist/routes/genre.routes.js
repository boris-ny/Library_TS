...
router
     ...
     */
    .post(authcontroller.permissionLevelRequired([user_models_1.PermissionLevel.ADMIN]), genreController.genreValidation, genreController.createGenre);
router
    .route("/:genreId")
    /**
     * Middleware to validate JWT token and check user permission level.
     ...
     */
    .delete(authcontroller.permissionLevelRequired([user_models_1.PermissionLevel.ADMIN]), genreController.deleteGenre);
