...
class Author extends sequelize_1.Model {
    ...
    get lifespan() {
        ...
        if (this.date_of_birth) {
            lifetime_string = luxon_1.DateTime.fromJSDate(this.date_of_birth).toLocaleString(luxon_1.DateTime.DATE_MED);
        }
        lifetime_string += " - ";
        if (this.date_of_death) {
            lifetime_string += luxon_1.DateTime.fromJSDate(this.date_of_death).toLocaleString(luxon_1.DateTime.DATE_MED);
        }
