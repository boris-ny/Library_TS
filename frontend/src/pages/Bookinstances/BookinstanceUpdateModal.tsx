...
const BookinstanceUpdateModal = (props) => {
  ...
  const formik = useFormik({
    initialValues: {
      book_id: props.bookinstance.book_id || "",
      imprint: props.bookinstance.imprint || "",
      status: props.bookinstance.status || "",
      due_back: props.bookinstance.dueback || "",
    },
  ...
  if (!props.bookinstance) {
    return null;
  }

  return (
    <>
      <Modal show={props.show} onHide={props.handleCloseUpdate}>
...
export default BookinstanceUpdateModal;
